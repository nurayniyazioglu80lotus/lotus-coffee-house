...
const products = [
  {
    name: "Cool Lime",
    price: "170₺",
    description: "Lime ve ferahlık hissiyle canlı içim.",
    image: "/uploads/qrmenu/cool-lime.jpg",
  },
  {
    name: "Very Berry Hibiscus",
    price: "180₺",
    description: "Meyvemsi ve hafif ekşi notalarıyla ferahlatıcı içecek.",
    image: "/uploads/qrmenu/very-berry-hibiscus.jpg",
  },
  {
    name: "Lemonade",
    price: "160₺",
    description: "Klasik limonata, serin ve taze içim.",
    image: "/uploads/qrmenu/lemonade.jpg",
  },
  {
    name: "Strawberry Lemonade",
    price: "170₺",
    description: "Çilek ve limon uyumuyla meyvemsi ferahlık.",
    image: "/uploads/qrmenu/strawberry-lemonade.jpg",
  },
];
...
export default function SerinleticilerPage() {
  return (
      ...
      <section className="bg-[#073c1f] text-white">
        <div className="mx-auto max-w-5xl px-5 py-10 text-center md:px-6 md:py-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#d7e4da] md:text-lg">
            Limonata ve meyveli ferah içecek seçeneklerimizi inceleyin.
            Taze, canlı ve yaz ruhuna uygun lezzetler burada.
          </p>
        </div>
      </section>
