...
const products = [
  {
    ...
    price: "250₺",
    description:
      "Matcha çayının süt ile birleştiği yumuşak ama karakterli içim.",
    image: "/uploads/qrmenu/matcha-latte.jpg",
  },
  {
    name: "Strawberry Matcha Latte",
    price: "260₺",
    description:
      "Çilek dokunuşuyla daha canlı ve tatlı matcha deneyimi.",
    image: "/uploads/qrmenu/strawberry-matcha-latte.jpg",
  },
];
      ...
      <section className="bg-[#073c1f] text-white">
        <div className="mx-auto max-w-5xl px-5 py-10 text-center md:px-6 md:py-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#d7e4da] md:text-lg">
            Canlı, modern ve karakterli matcha seçeneklerimizi inceleyin.
            Dengeli, özel ve dikkat çekici lezzetler burada.
          </p>
        </div>
      </section>
